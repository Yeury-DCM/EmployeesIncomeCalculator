...
{
    internal class FixedTermTeacher : Employee, ICalculateBonus
    {
        public bool GoalAchieved {get; set;}

        public decimal Bonus { get; set;}

        public FixedTermTeacher(string name, string lastName, string id, decimal salary) : base(name, lastName, id, salary) { }
